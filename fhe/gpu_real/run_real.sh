...
readonly BUILD_DIR="${FIDES_REAL_BUILD_DIR:-${SCRIPT_DIR}/build}"
...
readonly OUTPUT="$4"
readonly BINARY="${BUILD_DIR}/real_dnagpt_fides"
...
source_sha="$(sha256sum "${SCRIPT_DIR}/src/real_dnagpt_fides.cpp" | cut -d' ' -f1)"
