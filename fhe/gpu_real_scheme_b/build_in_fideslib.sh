...
cmake --build "${BUILD_DIR}" --target real_dnagpt_fides_scheme_b_simd_shard_mlp_reader_t103_depth13 --parallel "${JOBS}"
cmake --build "${BUILD_DIR}" --target real_dnagpt_fides_scheme_b_simd_shard_mlp_merge_t103_depth13 --parallel "${JOBS}"
...
echo "[build] ${BUILD_DIR}/real_dnagpt_fides_scheme_b_simd_shard_mlp_reader_t103_depth13"
echo "[build] ${BUILD_DIR}/real_dnagpt_fides_scheme_b_simd_shard_mlp_merge_t103_depth13"
