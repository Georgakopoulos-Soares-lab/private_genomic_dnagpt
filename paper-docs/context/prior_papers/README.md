...
The group's two previous submissions, kept here as style and structure reference for
`paper-style` and `paper-structure`. The PDFs are gitignored — they are large, and they are
published artifacts rather than sources for this repository.

| File | Repository it came from |
|---|---|
