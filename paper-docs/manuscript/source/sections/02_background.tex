...
workflow~\cite{concreteml,tfhers}. In this project's backend comparison, their available GPU
acceleration and ciphertext expansion were less suitable for this matrix-heavy graph than the
already validated CKKS path. A separate CKKS wrapper was not selected because its public interface
lacked the refresh and general
